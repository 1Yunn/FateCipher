        ...
        >
          <div className="rounded-3xl border border-border/60 bg-card/60 p-8 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.06)] backdrop-blur-xl sm:p-10">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-4">
              <div>
                <label htmlFor="signup-name" className="mb-1.5 block text-[12px] font-medium text-muted-foreground">
                  名字
                </label>
                <input
                  id="signup-name"
              ...
              <div>
                <label htmlFor="signup-email" className="mb-1.5 block text-[12px] font-medium text-muted-foreground">
                  邮箱
                </label>
                <input
                  id="signup-email"
              ...
              <div>
                <label htmlFor="signup-password" className="mb-1.5 block text-[12px] font-medium text-muted-foreground">
                  密码
                </label>
